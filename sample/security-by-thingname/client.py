...
message = {
    'source': thingName,
    'message': "this is the scanned message from " + thingName
}
...
while True:
    try:
        ...
        mqttc.publish(topicName, message, 1)
        print "Message Published to AWS IoT topic " + topicName
    except:
        print "Error publishing to the topic " + topicName
        exit(0)
    time.sleep(5)
